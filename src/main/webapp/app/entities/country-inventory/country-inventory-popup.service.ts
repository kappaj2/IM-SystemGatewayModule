...
@Injectable()
export class CountryInventoryPopupService {
            ...
            if (id) {
                this.countryService.find(id)
                    .subscribe((countryResponse: HttpResponse<CountryInventory>) => {
                        const country: CountryInventory = countryResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.countryModalRef(component, new CountryInventory());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    countryModalRef(component: Component, country: CountryInventory): NgbModalRef {
