package za.co.ajk.systemgateway.repository;

import za.co.ajk.systemgateway.SystemGatewayModuleApp;
import za.co.ajk.systemgateway.config.Constants;
import za.co.ajk.systemgateway.config.audit.AuditEventConverter;
import za.co.ajk.systemgateway.domain.PersistentAuditEvent;
...
import static za.co.ajk.systemgateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
