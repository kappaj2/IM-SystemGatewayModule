...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("SystemGatewayModule");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("SystemGatewayModule");
        ...
        config.getMapConfigs().put("za.co.ajk.systemgateway.domain.*", initializeDomainMapConfig(jHipsterProperties));
